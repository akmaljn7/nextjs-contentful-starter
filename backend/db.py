...
async def ensure_indexes():
    ...
    await db.refresh_tokens.create_index([("family_id", 1), ("revoked_at", 1)])
    ...
    await db.device_wakes.create_index([("org_id", 1), ("user_id", 1), ("ts_ms", -1)])
    await db.device_wakes.create_index("created_at_dt", expireAfterSeconds=60 * 60 * 24 * 14)
